...
<li class="mt">
  ...
  <li class="sub-menu">
    ...
    <ul class="sub">
      <li class="active"><a href="/reclamation">Historique Reclamation</a></li>
      ...
      <div class="panel-body">
        <div class="task-content">
          <ul id="sortable" class="task-list">
            ...
            @if($reclamation->user_id==Auth::user()->id)
            <li class="list-success">
              <i class=" fa fa-ellipsis-v"></i>
              
              <div class="task-title">
                <span class="task-title-sp">{{$reclamation->Titre}}</span>
                
                <span class="badge bg-important">{{Auth::user()->id}}</span>
