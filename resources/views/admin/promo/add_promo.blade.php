...
@endif
          ...
          <section id="main-content">
            <section class="wrapper site-min-height">
              <h3><i class="fa fa-angle-right"></i> Ajouter des Promotions</h3>
            
              <div class="row mt mb">
                <div class="col-lg-12">
                  <div class="form-panel">
                    <form class="form-horizontal style-form"  action="{{ route('admin.promo.store') }}" method="POST" enctype="multipart/form-data">
                      {{ method_field('GET') }}                      
                      <div class="form-group">
                        <label class="control-label col-md-3">Titre du Promo</label>
                        <div class="col-md-4">
                          <input size="16" type="text" name="Titre"  class=" form-control">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="date" name="date_deb"class="form-control"  size="16">        
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3">Date fin du Promo</label>
                        <div class="col-md-4">
                            <input type="date" name="date_fin"class="form-control"  size="16">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-4">
                            <input size="16" type="number" name="prix"  class=" form-control">
                          </div>
                        </div>
                        <div class="form-group">
