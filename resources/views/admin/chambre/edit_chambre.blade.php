...
@section('content')
          ...
          <section id="main-content">
            <section class="wrapper site-min-height">
              <h3><i class="fa fa-angle-right"></i> Modifier Chambre</h3>
              ...
              <div class="row mt mb">
                <div class="col-lg-12">
                  <div class="form-panel">
                    <form class="form-horizontal style-form"  action="{{ action ('AdminChambreController@update',$chambre->id) }}" method="PUT" enctype="multipart/form-data">
                        {{ method_field('POST') }}                      
                        <div class="form-group">
                          <label class="control-label col-md-3">Numero de chambre</label>
                          <div class="col-md-4">
                            <input size="16" type="text" name="numch"  value=" {{ $chambre->numch }} " class=" form-control" required>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-4">
                              <select class="form-control" name="categorie" >
                                  <option> {{ $chambre->categorie }} </option>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-4">
                              <select class="form-control" name="disponibilite" >
                                  <option>{{$chambre->disponibilite}}</option>
